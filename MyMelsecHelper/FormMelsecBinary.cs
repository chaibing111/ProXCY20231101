...
namespace MyMelsecHelper
{
    public partial class FormMelsecBinary : Form
    {
        ...
        public static FormMelsecBinary frmMelsecBinary = null;
        public static FormMelsecBinary GetInstance()
        {
            if (frmMelsecBinary == null || (frmMelsecBinary != null && frmMelsecBinary.IsDisposed))
            {
                frmMelsecBinary = new FormMelsecBinary();
            }
            return frmMelsecBinary;
        }
        ...
        private void button1_Click( object sender, EventArgs e )
        {
            ...
            #region MyRegion
            string plcName = comboBox_plcName.Text;
            if (string.IsNullOrEmpty(plcName)) return;
            if (!HslUtils.PlcsDic.ContainsKey(plcName))
            {
                if (comboBox_plcName.Items.IndexOf(plcName) < 0)
                    comboBox_plcName.Items.Add(plcName);
                PlcParm plc = new PlcParm();
                plc.PlcName = plcName;
                plc.IpAdr = textBox1.Text;
                plc.PortAdr = port;
                HslUtils.PlcsDic.Add(plcName, plc);
            }
            else
            {
                HslUtils.PlcsDic[plcName].PlcName = plcName;
                HslUtils.PlcsDic[plcName].IpAdr = textBox1.Text;
                HslUtils.PlcsDic[plcName].PortAdr = port;
            }
            HslUtils.PlcConnect(plcName);
            melsec_net = HslUtils.PlcsDic[plcName].melsecNet;
        ...
        private void button2_Click( object sender, EventArgs e )
        {
            ...
            DialogResult dr = MessageBox.Show("即将删除设备'" + plcName + "'的连接参数，是否继续？", "提示", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
            ...
            if (HslUtils.PlcsDic.ContainsKey(plcName))
            {
                HslUtils.PlcsDic.Remove(plcName);
            }

            if (comboBox_plcName.Items.IndexOf(plcName) >= 0)
            {
                comboBox_plcName.Items.Remove(plcName);
            }
        }
        #endregion
        ...
        {
            // 读取bool变量
            HslUtils.ReadResultRender( melsec_net.ReadBool( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_short_Click( object sender, EventArgs e )
        {
            // 读取short变量
            HslUtils.ReadResultRender( melsec_net.ReadInt16( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_ushort_Click( object sender, EventArgs e )
        {
            // 读取ushort变量
            HslUtils.ReadResultRender( melsec_net.ReadUInt16( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_int_Click( object sender, EventArgs e )
        {
            // 读取int变量
            HslUtils.ReadResultRender( melsec_net.ReadInt32( textBox3.Text ), textBox3.Text, textBox4 );
        }
        private void button_read_uint_Click( object sender, EventArgs e )
        {
            // 读取uint变量
            HslUtils.ReadResultRender( melsec_net.ReadUInt32( textBox3.Text ), textBox3.Text, textBox4 );
        }
        private void button_read_long_Click( object sender, EventArgs e )
        {
            // 读取long变量
            HslUtils.ReadResultRender( melsec_net.ReadInt64( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_ulong_Click( object sender, EventArgs e )
        {
            // 读取ulong变量
            HslUtils.ReadResultRender( melsec_net.ReadUInt64( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_float_Click( object sender, EventArgs e )
        {
            // 读取float变量
            HslUtils.ReadResultRender( melsec_net.ReadFloat( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_double_Click( object sender, EventArgs e )
        {
            // 读取double变量
            HslUtils.ReadResultRender( melsec_net.ReadDouble( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_string_Click( object sender, EventArgs e )
        {
            // 读取字符串
            HslUtils.ReadResultRender( melsec_net.ReadString( textBox3.Text, ushort.Parse( textBox5.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button24_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                HslUtils.WriteResultRender( melsec_net.Write( textBox8.Text,new bool[] { bool.Parse( textBox7.Text ) } ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button22_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                HslUtils.WriteResultRender( melsec_net.Write( textBox8.Text, short.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button21_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                HslUtils.WriteResultRender( melsec_net.Write( textBox8.Text, ushort.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button20_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                HslUtils.WriteResultRender( melsec_net.Write( textBox8.Text, int.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button19_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                HslUtils.WriteResultRender( melsec_net.Write( textBox8.Text, uint.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button18_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                HslUtils.WriteResultRender( melsec_net.Write( textBox8.Text, long.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button17_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                HslUtils.WriteResultRender( melsec_net.Write( textBox8.Text, ulong.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button16_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                HslUtils.WriteResultRender( melsec_net.Write( textBox8.Text, float.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button15_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                HslUtils.WriteResultRender( melsec_net.Write( textBox8.Text, double.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button14_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                HslUtils.WriteResultRender( melsec_net.Write( textBox8.Text, textBox7.Text ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void test2( )
        {
            bool[] values = new bool[] { true, true, true, true, true, true, true, true, true, true };
        ...
        #endregion
        private void comboBox_plcName_init()
        {
            comboBox_plcName.Items.Clear();
        ...
        private void FormMelsecBinary_VisibleChanged(object sender, EventArgs e)
        {
            if (this.Visible)
            {
                comboBox_plcName_init();
        ...
        private void comboBox_plcName_SelectedIndexChanged(object sender, EventArgs e)
        {
            string plcName = comboBox_plcName.Text;
            if (string.IsNullOrEmpty(plcName)) return;
            if (HslUtils.PlcsDic.ContainsKey(plcName))
            {
                textBox1.Text = HslUtils.PlcsDic[plcName].IpAdr;
                textBox2.Text = HslUtils.PlcsDic[plcName].PortAdr.ToString();
                //textBox_LocIpHead.Text = ((int)HslUtils.PlcsDic[plcName].LocIpHead).ToString();
                //comboBox_ABCD.Text = HslUtils.PlcsDic[plcName].ABCDtype.ToString();
