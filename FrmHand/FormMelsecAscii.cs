...
namespace sunyvpp
{
    public partial class FormMelsecAscii : UIForm
    {
        public static FormMelsecAscii frmMelsecAscii = null;
        public static FormMelsecAscii GetInstance()
        {
            if (frmMelsecAscii == null || (frmMelsecAscii != null && frmMelsecAscii.IsDisposed))
            {
                frmMelsecAscii = new FormMelsecAscii();
            }
            return frmMelsecAscii;
        }
